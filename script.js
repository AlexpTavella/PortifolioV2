...
let baseZOffset = 0.0003; //how quickly the noise should move
...
// ============================================
// ANIMAÇÃO FADE-UP (EXECUTA APENAS UMA VEZ)
// ============================================
...
const observer = new IntersectionObserver((entries) => {
    ...
    entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
            ...
            // Assim a animação acontece apenas uma vez
    ...
    // Dispara quando cerca de 15% do elemento
    // estiver visível
    threshold: 0.50,

    // Faz a animação começar um pouco antes
    // do elemento aparecer totalmente
...
document.querySelectorAll('a[href^="#"]').forEach(link => {
    ...
    link.addEventListener('click', function (e) {
        ...
        // Centraliza o elemento verticalmente na tela
        const y =
